...
Uses temporal validation split (first 80% train, last 20% validation, no shuffling).
...
def _temporal_split(X, y, val_ratio=0.2):
...
def main():
    ...
    print(f"Group A: Subject-Dependent (unified hyperparams, temporal val)")
